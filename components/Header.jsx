...
export default function Header() {
	return (
		<header className="flex items-center justify-between h-24 p-4 bg-gray-200">
			...
			<Link href='/protected/admin' className="flex items-center justify-center h-12 text-center px-4 py-2 text-gray-800 hover:bg-gray-100 hover:rounded-lg">Admin</Link>
